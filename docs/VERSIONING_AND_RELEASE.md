...
| `v1.1.0` | New features added (minor) |
| `v1.1.1` | Bug fix to v1.1.0 (patch) |
| `v2.0.0` | Breaking changes or major milestone |

Public versions follow standard [semver](https://semver.org/):
- **Major** bumps for breaking changes or big milestones (your "round up to 2" moments)
...
|--------------|------------|------|-------|
| dev-1.8.2 | v1.0.0 | 2026-03-15 | Initial public release |
| dev-1.12.0 | v1.1.0 | 2026-04-20 | Wiki inline editing |
| dev-2.1.0 | v2.0.0 | 2026-07-01 | Teams support |
```
