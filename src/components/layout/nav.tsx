...
const navSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/do-now/card-file", label: "Card File", icon: RotateCcw },
    ],
  },
  {
    label: "Lists",
    ...
    <TooltipProvider delayDuration={0}>
      <div className="flex h-full flex-col">
        <div className={cn("flex items-start py-4", collapsed ? "justify-center px-1" : "justify-between px-4")}>
          {!collapsed && (
            <div className="group">
              <a href="https://www.courtemancheatelier.studio/tandem-gtd/" target="_blank" rel="noopener noreferrer"><h1 className="text-lg font-bold leading-7 hover:text-primary transition-colors">Tandem GTD™</h1></a>
              <div className="overflow-hidden max-h-0 group-hover:max-h-5 transition-all duration-200 ease-out">
                <p className="text-[11px] text-muted-foreground text-center">
                  v{process.env.NEXT_PUBLIC_APP_VERSION ?? "1.8"}
