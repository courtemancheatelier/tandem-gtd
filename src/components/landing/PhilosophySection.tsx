...
const principles = [
  ...
  },
  {
    ...
    description:
      "Whether you self-host or use our managed hosting, your data stays under your control. Export anytime, migrate anytime. No lock-in.",
  },
  {
    icon: Bot,
  ...
  {
    icon: LockOpen,
    title: "Open source, no feature walls.",
    description:
      "AGPL-3.0 licensed. Every feature ships to every user \u2014 self-hosted or managed. Inspect the code, contribute improvements, run it forever.",
  },
];
