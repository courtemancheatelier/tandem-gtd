    ...
    <div className="space-y-4 w-full max-w-sm">
      ...
      <Card>
        <CardHeader className="space-y-1">
          ...
          <CardDescription>
            {isClosed
              ? "Registration is currently closed. Existing users can still sign in."
              : isWaitlist
              ? "Tandem is in private beta. Sign in if you already have an account."
              : isInviteOnly
              ? "Sign in to your account, or enter an invite code to join."
              : isTrial
              ? `Try Tandem free for ${trialDurationDays} days. No credit card required.`
              ...
              <div className="space-y-2">
                ...
                {hasApple && (
                  <Button
                    ...
                    disabled={oauthDisabledForInvite}
                    onClick={() =>
                      signIn("apple", { callbackUrl: "/do-now" })
                    }
                  >
                    <AppleIcon />
                    Continue with Apple
                ...
                {hasGitHub && (
                  <Button
                    ...
                    disabled={oauthDisabledForInvite}
                    onClick={() =>
                      signIn("github", { callbackUrl: "/do-now" })
                    }
                  >
                    <GitHubIcon />
                ...
                {hasMicrosoft && (
                  <Button
                    ...
                    disabled={oauthDisabledForInvite}
                    onClick={() =>
                      signIn("azure-ad", { callbackUrl: "/do-now" })
                    }
                  >
                    <MicrosoftIcon />
      ...
      {isTrial && hasOAuth && (
        <Card>
          <CardHeader className="space-y-1 pb-2">
            <CardTitle className="text-lg">Try Tandem Free</CardTitle>
            <CardDescription>
              Start your {trialDurationDays}-day free trial. No credit card required.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-2">
            {hasGoogle && (
