...
function WikiPageContent() {
  ...
  const [activeScope, setActiveScope] = useState<string>(scopeParam === "all" ? "all" : teamIdParam || "personal");
  ...
  }, [teamIdParam, scopeParam]);

  const currentTeamId = activeScope !== "personal" && activeScope !== "all" ? activeScope : null;
