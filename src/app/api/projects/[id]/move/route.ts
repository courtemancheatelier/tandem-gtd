...
import { computeChildSortOrder } from "@/lib/sub-project-sequencing";
...
export async function PATCH(
  ...
  // Compute sortOrder: place at end of new parent's children
  const sortOrder = newParentId
    ? await computeChildSortOrder(newParentId)
    : 0;
