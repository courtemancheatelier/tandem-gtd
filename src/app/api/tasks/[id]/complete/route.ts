...
export async function POST(
  ...
  try {
    ...
    actualMinutes = typeof body.actualMinutes === "number" && body.actualMinutes > 0 && body.actualMinutes <= 14400
      ? Math.round(body.actualMinutes)
      : undefined;
  } catch {
  ...
  try {
    ...
    // If actualMinutes was provided, update it on the completed task
