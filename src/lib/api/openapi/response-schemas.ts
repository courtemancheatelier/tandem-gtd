...
const UserRef = z.object({ id, name: z.string() });

export const ThreadMessageResponse = z.object({
  id,
  content: z.string(),
  authorId: z.string(),
  author: UserRef,
...
export const ThreadResponse = z.object({
  ...
  title: z.string(),
  resolvedAt: nullableDateString,
  createdById: z.string(),
  createdBy: UserRef,
  taskId: z.string().nullable(),
  projectId: z.string().nullable(),
  messages: z.array(ThreadMessageResponse),
  createdAt: dateString,
  updatedAt: dateString,
});

export const ThreadListResponse = z.array(ThreadResponse);

// ---------------------------------------------------------------------------
// Decision
// ---------------------------------------------------------------------------

export const DecisionOptionResponse = z.object({
  id,
  label: z.string(),
  description: z.string().nullable(),
  sortOrder: z.number(),
  isChosen: z.boolean(),
  votes: z.array(z.object({ id, voterId: z.string(), voter: UserRef })),
});

export const DecisionResponseItem = z.object({
  id,
...
export const DecisionResponse = z.object({
  ...
  decisionType: z.enum(["APPROVAL", "POLL"]),
  status: z.enum(["OPEN", "RESOLVED", "WITHDRAWN", "EXPIRED"]),
  resolution: z.string().nullable(),
  deadline: nullableDateString,
  wikiSlug: z.string().nullable(),
  requesterId: z.string(),
  requester: UserRef,
  respondents: z.array(z.object({ user: UserRef })),
  responses: z.array(DecisionResponseItem),
  options: z.array(DecisionOptionResponse),
  optionVotes: z.array(z.object({ id, voterId: z.string(), voter: UserRef, optionId: z.string() })),
  thread: z.object({
    id,
    taskId: z.string().nullable(),
    projectId: z.string().nullable(),
...
export const DecisionListResponse = z.array(DecisionResponse);
